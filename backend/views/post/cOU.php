        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <select name="category" class="form-control">
                    <?php
                    $values=Yii::$app->params["categories"];
                    foreach($values as $v){
                        ?>

                        <option
                            <?php if(isset($model)&&$model->category==$v){
                                echo "selected";
                            } ?>
...
$this->registerJsFile("@web/js/src/postCOU.js",['depends' => [backend\assets\AppAsset::className()]]);
?>